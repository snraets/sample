...
/***/ function(module, exports, __webpack_require__) {
	...
	function ready() {
	    (0, _jquery2.default)(document).ready(_start2.default);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Start() {
	    ...
	    model.subscribeChores(_builder.buildChores);

	    model.init();

	    _Observable.Observable.fromEvent((0, _jquery2.default)('#addChore'), 'click').subscribe(function (event) {

	        var newChore = [{ "id": null, "name": (0, _jquery2.default)("#newChore").val(), userId: null }];

	        model.addChores(newChore);

	        (0, _jquery2.default)("#newChore").val('');
	    }, function () {});

	    _Observable.Observable.fromEvent((0, _jquery2.default)("#choresList"), 'click').subscribe(function (event) {
	    ...
	    _Observable.Observable.fromEvent((0, _jquery2.default)("#sortChores"), 'click').subscribe(function (event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Model = function () {
	    function Model() {
	        ...
	        this.choresSubject = new _Subject.Subject();
	        this.usersSubject = new _Subject.Subject();
	    }
	    ...
	    _createClass(Model, [{
	        ...
	        value: function init() {
	            ...
	            var model = this;
	            var addChores = this.addChores;

	            this.choresSubject.subscribe();

	            var choresObservable = _Observable.Observable.ajax({
	            ...
	            var usersObservable = _Observable.Observable.ajax({
	            ...
	            _Observable.Observable.forkJoin(choresObservable, usersObservable).subscribe(function (results) {

	                var boundAddChores = addChores.bind(model);
	        ...
	        key: 'subscribeChores',
	        value: function subscribeChores(observer) {
	            this.choresSubject.subscribe(observer);
	        }
	    }, {
	        key: 'updateChores',
	        value: function updateChores() {
	            this.choresSubject.next(this.chores);
	        }
	    }, {
	        key: 'addChores',
	        value: function addChores(chores) {

	            var model = this;
	            var updateChores = this.updateChores;
	            var choresCallList = [];

	            var newChores = _lodash2.default.filter(chores, { "id": null });

	            if (newChores.length === 0) {
	                var _chores;

	                (_chores = this.chores).push.apply(_chores, _toConsumableArray(chores));
	                this.updateChores();
	            } else {

	                _lodash2.default.forEach(newChores, function (chore) {

	                    choresCallList.push(_Observable.Observable.ajax({
	                        url: 'http://localhost:3000/chores',
	                        method: 'POST',
	                ...
	                _Observable.Observable.forkJoin.apply(null, choresCallList).subscribe(function (results) {

	                    var boundUpdateChores = updateChores.bind(model);

	                    _lodash2.default.forEach(results, function (AjaxResponse) {
	        ...
	        key: 'sortChores',
	        value: function sortChores() {
	            this.chores = _lodash2.default.sortBy(this.chores, ['name']);
	            this.updateChores();
	        }
	    }, {
	        key: 'deleteChores',
	        value: function deleteChores(id) {

	            var parsedIndex = parseInt(id);
	            var model = this;
	            var updateChores = this.updateChores;
	            ...
	            _Observable.Observable.ajax({
	                ...
	                model.chores = _lodash2.default.pullAllBy(model.chores, [{ 'id': parsedIndex }], 'id');
	                boundUpdateChores();
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var AjaxObservable_1 = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(4);
	var forkJoin_1 = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var choresTemplate = '<% _.forEach(chores, function(chore) \n        { %><tr>\n            <td><%- chore.name %></td>\n            <td><button id="<%- chore.id %>" class="btn btn-xs">remove</button></td>\n        </tr><% }\n    ); %>';

	function buildChores(chores) {

	    "use strict";

	    var compiledTemplate = _lodash2.default.template(choresTemplate);

	    (0, _jquery2.default)('#choresList').empty().append(compiledTemplate({ 'chores': chores }));
	}

	exports.buildChores = buildChores;
